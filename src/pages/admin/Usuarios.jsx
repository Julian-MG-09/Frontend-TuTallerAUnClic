...
const MOCK_USUARIOS = [
  { id: 1, username: 'carlos123', first_name: 'Carlos', last_name: 'Gomez', email: 'carlos@mail.com', telefono: '3001234567', is_active: true,  rol: 'Cliente' },
  { id: 2, username: 'maria_e',   first_name: 'Maria',  last_name: 'Estrada', email: 'maria@mail.com', telefono: '3119876543', is_active: true,  rol: 'Empresa' },
  { id: 3, username: 'admin01',   first_name: 'Julian', last_name: 'MG',      email: 'admin@mail.com', telefono: '3005557777', is_active: false, rol: 'Admin'   },
]

const EMPTY_FORM = {
  username: '', first_name: '', last_name: '',
  email: '', telefono: '', rol: 'Cliente', is_active: true,
}
        ...
        >
          <div className="flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-3">
              <Field label="Nombre" value={form.first_name}
                onChange={v => setForm(f => ({ ...f, first_name: v }))} />
              <Field label="Apellido" value={form.last_name}
                onChange={v => setForm(f => ({ ...f, last_name: v }))} />
            </div>
            <Field label="Usuario" value={form.username}
              onChange={v => setForm(f => ({ ...f, username: v }))} />
            <Field label="Correo" type="email" value={form.email}
  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full px-3 py-2 text-sm rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
      />
    </div>
  )
}